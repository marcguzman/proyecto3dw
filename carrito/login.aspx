...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">
		<div class="span4">
			<div class="well">
			<h5>Crear su cuenta</h5><br/>
			
Introduzca su dirección de correo electrónico para crear una cuenta.<br/><br/><br/>
			<form action="register.html">
			  <div class="control-group">
				<label class="control-label" for="inputEmail0">Direccion E-mail </label>
				<div class="controls">
				  <input class="span3"  type="text" id="inputEmail0" placeholder="Email">
				</div>
			  </div>
			  <div class="controls">
			  <button type="submit" class="btn block">Crear su cuenta</button>
			  </div>
			</form>
		</div>
		</div>
		...
		<div class="span4">
			...
			<form>
			  ...
			  <div class="control-group">
				<div class="controls">
				  <button type="submit" class="btn">Registrarse</button> <a href="forgetpass.html">Olvido  la contraseña?</a>
				</div>
			  </div>
			</form>
		</div>
