<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="carrito.contact" %>
...
<div class="container">
	...
	<div class="row">
		...
		<p>	3a. Avenida 9-00 zona 2, Interior Finca El Zapote ,<br/> Ciudad de Guatemala, Guatemala, C.A.
			<br/><br/>
			info@umg.edu.gt<br/>
			﻿Teléfono: +502 24111800<br/>
			Fax 24111800<br/>
			web:bootsshop.com
		</p>		
		</div>
		...
		<h4>Horario de apertura</h4>
			...
			<h5>Sabado</h5>
			<p>07:00am - 07:00pm<br/><br/></p>
			<h5>Domingo</h5>
			<p>07:00pm - 06:00pm<br/><br/></p>
		</div>
		<div class="span4">
		<h4>Escribenos</h4>
