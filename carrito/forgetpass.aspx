<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgetpass.aspx.cs" Inherits="carrito.forgetpass" %>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">
		<div class="span9" style="min-height:900px">
			<div class="well">
			<h5>
Restablecer su contraseña</h5><br/>
			
Por favor, introduzca la dirección de correo electrónico para su cuenta. Se le enviará un código de verificación. Una vez que haya recibido el código de verificación, podrá elegir una nueva contraseña para su cuenta.<br/><br/><br/>
			<form>
			  <div class="control-group">
				<label class="control-label" for="inputEmail1">Direccion E-mail </label>
				<div class="controls">
