<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="carrito.register" %>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="company">Compania</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="address" placeholder="Adress"/> <span>Calle,Colonia</span>
			</div>
		</div>
		
		<div class="control-group">
			<label class="control-label" for="address2">Direccion (Linea 2)<sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="address2" placeholder="Adress line 2"/> <span>Apartmento, Numero de Casa, Zona, etc.</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="state">Estado<sup>*</sup></label>
			<div class="controls">
			  <select id="state" >
				<option value="">-</option>
		...
		<div class="control-group">
			<label class="control-label" for="aditionalInfo">Informacion Adicional</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text"  name="phone" id="phone" placeholder="phone"/> <span>Debe registrar al menos un número de teléfono</span>
			</div>
		</div>
		
		<div class="control-group">
			<label class="control-label" for="mobile">Telefono Celular </label>
			<div class="controls">
			  <input type="text"  name="mobile" id="mobile" placeholder="Mobile Phone"/> 
			</div>
		</div>
		
	<p><sup>*</sup>Dato Requerido	</p>
