<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compair.aspx.cs" Inherits="carrito.compair" %>
...
<div id="welcomeLine" class="row">
	<div class="span6">Bienveido!<strong> User</strong></div>
	<div class="span6">
...
<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		<div class="well well-small"><a id="myCart" href="product_summary.html"><img src="themes/images/ico-cart.png" alt="cart">3 Articulos en el carro  <span class="badge badge-warning pull-right">$155.00</span></a></div>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Comparacion de productos</li>
    </ul>
	<h3> Comparacion de productos <small class="pull-right"> 2 productos son comparados </small></h3>	
	<hr class="soft"/>
