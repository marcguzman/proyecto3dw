<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="carrito.products" %>
...
<div id="welcomeLine" class="row">
	<div class="span6">Bievenido!<strong> User</strong></div>
	<div class="span6">
	...
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			...
			<ul style="display:none">
				...
				<li><a href="products.html"><i class="icon-chevron-right"></i>Ropa para Ni�os (5)</a></li>												
				<li><a href="products.html"><i class="icon-chevron-right"></i>Zapatos para ni�os (3)</a></li>												
			</ul>
			</li>
		...
		<br/>
		  <div class="thumbnail">
			...
			<div class="thumbnail">
				...
				<div class="caption">
				  <h5>Kindle</h5>
				    <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">A�adir <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$222.00</a></h4>
				</div>
			  </div><br/>
			<div class="thumbnail">
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Nombre de productos</li>
    </ul>
	<h3> Nombres de productos <small class="pull-right"> 40 productos estan disponibles </small></h3>	
	<hr class="soft"/>
	<p>
		
Hoy en d�a la industria de la "productos" es una de las esferas de negocios m�s exitosas. Siempre estamos en contacto con las �ltimas tendencias de la moda - es por eso que nuestros productos son tan populares y tenemos un gran n�mero de clientes fieles en todo el pa�s.
	</p>
	<hr class="soft"/>
	<form class="form-horizontal span6">
		<div class="control-group">
		  <label class="control-label alignL">Ordenar por </label>
			<select>
              <option>Nombre producto A - Z</option>
              <option>Nombre producto Z - A</option>
              <option>Producto Stoke</option>
              <option>Precios bajos primero</option>
            </select>
		</div>
	  </form>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		...
		<div class="row">	  
			...
			<div class="span3 alignR">
				...
				<a href="product_details.html" class="btn btn-large btn-primary"> A�adir <i class=" icon-shopping-cart"></i></a>
				<a href="product_details.html" class="btn btn-large"><i class="icon-zoom-in"></i></a>
			  ...
			  <div class="thumbnail">
				...
				<div class="caption">
				  ...
				  <p> 
				   ...
				   <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">A�adir <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Q222.00</a></h4>
				</div>
			  </div>
			</li>
			<li class="span3">
	...
	<a href="compair.html" class="btn btn-large pull-right">Comparar Producto</a>
