...
namespace ComponenteDatos
{
    public class VentasDA
    {
        ...
        public string Insertar(Ventas prod)
        {
            ...
            try
            {
                ...
                cmdVentas.Connection = conn.conectarBD();
                {
                    ...
                    cmdVentas.Parameters.AddWithValue("@medio", prod.MPAGO);
                }
                int registros;
        ...
        public DataTable cboformadepago()
        {
            DataTable dt = new DataTable();

            string strComando = "";
            strComando = "SELECT * FROM medio_pago";            
            SqlCommand cmd = new SqlCommand(strComando, conn.conectarBD());
