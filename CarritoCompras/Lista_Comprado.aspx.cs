    ...
    public partial class Lista_Comprado : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                ...
                DropDownList1.DataSource = cdao.cboformadepago();
                DropDownList1.DataValueField = "id_medio";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            oMatriculaCE.MPAGO = Convert.ToInt32(DropDownList1.SelectedValue);
        ...
        protected void SendEmail(object sender, EventArgs e)
        {
            ...
            correo.From = new System.Net.Mail.MailAddress("tuscomprasumg@gmail.com");
            ...
            correo.Body = "Hola " + txtCliente.Text + " Usted ha realizado un pedido por la cantidad de :  " + lblTotal.Text + "\r\n" + des;
            ...
            smtp.Port = 587;
            smtp.Credentials = new System.Net.NetworkCredential("tuscomprasumg@gmail.com", "tuscompras");
            smtp.EnableSsl = true;
            try
            {
                smtp.Send(correo);
